...
Requires: torch, transformers, pyyaml (optional), psutil (optional)
"""
...
def train_benchmark(model, loader, dataset, collator_stats, cfg, device, steps=500):
    ...
    for step in range(steps):
        ...
        with autocast(device_type='cuda', enabled=use_amp), record_function("forward"):
    ...
    print(f"nvidia-smi overhead       : {smi_time:8.4f} s")
    ...
    return {
        ...
        "tokens_per_sec": token_total / sum(step_times),
